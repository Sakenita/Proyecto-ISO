						...
						$msg</div>" ?> 
							...
							<form method="POST">
                                ...
                                <div class="form-group">
									...
									<input type="number" class="form-control" name="contactnumber"  value="<?php  echo $row['MobileNumber'];?>" required="true">
								</div>
                                </div>

                                    <center>
                                    <button type="submit" class="btn btn-info" name="submit-profile">Modificar</button>
